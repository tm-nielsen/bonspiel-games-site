...
const MobileNav = () => {
  ...
  return (
    <div className="mobile-navbar">
        ...
        <button className={`nav-button${expanded? " nav-button-expanded":""}`} onClick={() => setExpanded(!expanded)}>
        ...
        <div className="mobile-nav-background">
          <nav>
            <ul className="mobile-nav-list">
              <li>
                <Link to={{pathname: "", hash: ""}} className="mobile-nav-link" onClick={onLinkClicked}>
                  Curl
                </Link>
              </li>
              <li>
                <Link to={{pathname: "", hash: "faq"}} className="mobile-nav-link" onClick={onLinkClicked}>
                  FAQ
                </Link>
              </li>
              <li>
                <Link to={{pathname: "", hash: "team"}} className="mobile-nav-link" onClick={onLinkClicked}>
                  Team
                </Link>
              </li>
              <li>
