  ...
  return (
    <div className="explanation">
      ...
      <p className="no-indent">
        This section assumes you have seen 'The Readable Version' to avoid repitition and will focus on the use of BCI technology with <Title />. If you want more info on BCI technology itself,{' '}
      ...
      <p>
        Two options are presented. The primary is a positive selection, for which input must be performed. The other is the default. A bar starts filled partway between the two options. Hold down to fill up, otherwise the bar will slowsly empty towards the default option. A selection is made once the bar reaches either end. Only two optoins can be selected, and the paradigm is best suited to options that fit naturally into the active and default roles, such as "play again" or "return to menu".
      </p>
